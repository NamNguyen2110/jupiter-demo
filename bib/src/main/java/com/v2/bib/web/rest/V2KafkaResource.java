...
@RestController
@RequestMapping("/api/v-2-kafka")
public class V2KafkaResource {

    private final Logger log = LoggerFactory.getLogger(V2KafkaResource.class);
    ...
    public V2KafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
